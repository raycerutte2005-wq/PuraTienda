...
const QR_IMAGE_URL = "Imagenes/descarga.jpg"; // Ej: "img/qr-tarjeta.png"
...
function renderCart() {
  ...
  content.innerHTML = `
    ...
    <div class="qr-section">
      ...
      <p class="qr-instructions">Si desea pagar por transferencia, escanea el código QR con tu app bancaria y realiza la transferencia por el monto exacto.</p>
    </div>
    <div class="comprobante-form">
      <label class="form-label">Nombre y Apellidos</label>
      <input class="form-input" type="text" placeholder="Nombre completo" id="clientName" />
      <label class="form-label">Provincia</label>
      <input class="form-input" type="text" id="clientAddress" />
      <label class="form-label">Municipio</label>
      <input class="form-input" type="text" id="clientAddress2" />
      <label class="form-label">Direccion</label>
      <input class="form-input" type="tel" placeholder="Calle y Numero de la Casa" id="clientAddress3" />
...
function sendOrder() {
  ...
  const province = document.getElementById('clientAddress').value.trim();
  const town     = document.getElementById('clientAddress2').value.trim();
  const address  = document.getElementById('clientAddress3').value.trim();
  const phone    = document.getElementById('clientPhone').value.trim();

  if (!name || !province || !town || !address || !phone) {
  ...
  content.innerHTML = `
    <div style="text-align:center;padding:40px 0;display:flex;flex-direction:column;align-items:center;gap:16px;">
      ...
      <div style="font-family:'Playfair Display',serif;font-size:1.4rem;font-weight:700">¡Pedido enviado!</div>
